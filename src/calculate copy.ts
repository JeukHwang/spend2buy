...
//   }
//   static gcd(array: number[]): number {
//     let result = array[0];
...
//   static test() {
//     let flag = true;
//     for (const problem of [...this.problems, ...problems]) {
//       const t = Date.now();

//       const result = Calculator.naiveDP(problem[0], problem[1]);
//       const dt = Date.now() - t;
//       if (JSON.stringify(result) !== JSON.stringify(problem[2])) {
//         console.log("failed");
...
// Calculator.test();
// // const options: { [key in string]: { value: number; cost: number } } = {
// //   1: { value: 60 + 0, cost: 1200 },
// //   2: { value: 185 + 9, cost: 3900 },
// //   3: { value: 305 + 15, cost: 5900 },
// //   4: { value: 690 + 33, cost: 14000 },
// //   5: { value: 2025 + 98, cost: 39000 },
// //   6: { value: 3330 + 168, cost: 57000 },
// //   7: { value: 6590 + 328, cost: 119000 },
// // };

// // const options = Optimizer.problems[0][0];

// // const best_option = Object.entries(options).reduce(
// //   (
// //     prev: [string, { value: number; cost: number }],
// //     curr: [string, { value: number; cost: number }]
// //   ) => {
// //     return prev[1].value / prev[1].cost > curr[1].value / curr[1].cost
// //       ? prev
// //       : curr;
// //   },
// //   ["", { value: 0, cost: Infinity }]
// // )[0];

// // // find the first periodicity
// // let period_start: number = 0;
// // for (let i = 1; i < 100000; i++) {
// //     if (i % 1000 === 0) console.log(i);
// //   const choice = Optimizer.naiveDP(options, i);
// //   const choice_period = Optimizer.naiveDP(options, i + options[best_option].value);
// //   const might_be_period =
// //     JSON.stringify({ ...choice, best_option: choice[best_option] + 1 }) ===
// //     JSON.stringify(choice_period);
// //   if (might_be_period && period_start + options[best_option]!.value === i) {
// //     console.log("periodicity", period_start);
// //     break;
// //   } else {
// //     period_start = i;
// //   }
...
// // // const x = 1000_0000;
// // // const t = Date.now();
// // // console.log(Optimizer.naiveDP(options, x));
// // // console.log(Date.now() - t);

// // // console.log(Optimizer.gcd([0.01, 0.03, 0.06]))
